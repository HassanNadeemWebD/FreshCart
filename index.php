              ...
              <div class="card card-product">
                <div class="card-body">
                  ...
                  <div class="text-center position-relative ">
                    ...
                    <a href="#!"> <img src="assets/images/products/<?php echo $row['img'] ?>" alt="Grocery Ecommerce Template"
                  ...
                  <h2 class="fs-6"><a href="pages/shop-single.php" class="text-inherit text-decoration-none"><?php echo $row['productName'] ?></a></h2>
                  <div>
                  ...
                  <div class="d-flex justify-content-between align-items-center mt-3">
                    <div><span class="text-dark">$<?php echo $row['price'] ?></span>
                     <!-- <span
